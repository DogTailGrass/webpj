                ...
                <el-col :xs="4" :sm="4" :md="4" :lg="4">
                    <div>
                        <el-menu default-active="1" class="el-menu-vertical-demo" style="min-height:800px" @select="handleSelect">
                            <el-menu-item index="1"><i class="el-icon-message"></i>学生登录</el-menu-item>
                            <el-menu-item index="2"><i class="el-icon-menu"></i>管理员登录</el-menu-item>
            ...
            handleSelect(key, keyPath){
                switch(key){
                    case '1':
                        ...
                        this.breadcrumbItems  = ['学生登录']
                        break;
                    case '2':
                        this.$router.push('/adminlogin')
                        this.breadcrumbItems  = ['管理员登录']
                        break;
                    case '3':
                        this.$router.push('/studentlogin')
